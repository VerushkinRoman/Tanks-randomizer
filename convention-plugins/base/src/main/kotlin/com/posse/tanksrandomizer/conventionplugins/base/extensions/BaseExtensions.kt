...
private val Project.androidApplicationExtension: BaseAppModuleExtension
    get() = extensions.findByType(BaseAppModuleExtension::class)
        ?: error(
            "\"Project.androidExtension\" value may be called only from android application"
        )
...
fun Project.androidApplication(block: BaseAppModuleExtension.() -> Unit): Unit =
    block(androidApplicationExtension)
