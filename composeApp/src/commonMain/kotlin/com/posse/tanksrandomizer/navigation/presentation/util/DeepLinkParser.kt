package com.posse.tanksrandomizer.navigation.presentation.util
...
object DeepLinkParser {
    fun parse(uri: String?): DeepLinkResult? {
    ...
    private fun getError(params: Map<String, String?>?): DeepLinkResult.Error? {
        return params?.let {
