package com.posse.tanksrandomizer.feature_offline_pane.compose.util
...
fun <T> getFilterImage(item: ItemStatus<T>): Painter {
    return when (item) {
        is Level -> {
            when (item) {
                is Level.Level1 -> painterResource(FilterUIObjectData.Level1.drawableResource)
                is Level.Level2 -> painterResource(FilterUIObjectData.Level2.drawableResource)
                is Level.Level3 -> painterResource(FilterUIObjectData.Level3.drawableResource)
                is Level.Level4 -> painterResource(FilterUIObjectData.Level4.drawableResource)
                is Level.Level5 -> painterResource(FilterUIObjectData.Level5.drawableResource)
                is Level.Level6 -> painterResource(FilterUIObjectData.Level6.drawableResource)
                is Level.Level7 -> painterResource(FilterUIObjectData.Level7.drawableResource)
        ...
        is Nation -> {
            when (item) {
                ...
                is Nation.Europe -> painterResource(FilterUIObjectData.Europe.drawableResource)
                ...
                is Nation.GreatBritain -> painterResource(FilterUIObjectData.GreatBritain.drawableResource)
...
fun <T> getFilterName(item: ItemStatus<T>): String {
    return when (item) {
        is Level -> {
            when (item) {
                is Level.Level1 -> stringResource(FilterUIObjectData.Level1.stringResource)
                is Level.Level2 -> stringResource(FilterUIObjectData.Level2.stringResource)
                is Level.Level3 -> stringResource(FilterUIObjectData.Level3.stringResource)
                is Level.Level4 -> stringResource(FilterUIObjectData.Level4.stringResource)
                is Level.Level5 -> stringResource(FilterUIObjectData.Level5.stringResource)
                is Level.Level6 -> stringResource(FilterUIObjectData.Level6.stringResource)
                is Level.Level7 -> stringResource(FilterUIObjectData.Level7.stringResource)
        ...
        is Nation -> {
            when (item) {
                ...
                is Nation.Europe -> stringResource(FilterUIObjectData.Europe.stringResource)
                ...
                is Nation.GreatBritain -> stringResource(FilterUIObjectData.GreatBritain.stringResource)
