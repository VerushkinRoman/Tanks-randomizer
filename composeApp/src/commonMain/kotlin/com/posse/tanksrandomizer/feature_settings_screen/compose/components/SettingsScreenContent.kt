    ...
    CommonScreenColumn(
        ...
        if (rotationAvailable) {
            ...
            RotationBlock(
                ...
                onRotationChanged = { onEvent(SettingsEvent.RotationChanged(it)) },
                modifier = Modifier.fillMaxWidth(),
            )
        }
        ...
        if (overlayAvailable) {
            ...
            FullScreenSwitch(
                ...
                onModeChanged = { onEvent(SettingsEvent.FullScreenModeChanged(it)) },
                modifier = Modifier.fillMaxWidth(),
            )
            ...
            AutoHideSwitch(
                autoHideEnabled = viewState.autoHide,
                enabled = !viewState.fullScreenMode,
                onAutoHideChanged = { onEvent(SettingsEvent.AutoHideChanged(it)) },
                modifier = Modifier.fillMaxWidth(),
            )
