package com.posse.tanksrandomizer.feature_offline_navigation.common.domain.repository

import com.posse.tanksrandomizer.common.data.datasource.OfflineDataSource
import com.posse.tanksrandomizer.feature_offline_navigation.feature_offline_screen.data.datasource.OfflineScreenDataSource
...
class OfflineScreenRepositoryImpl(
    ...
    override fun getQuantity(id: String): Int = offlineScreenDataSource.getQuantity(id)
    override fun setQuantity(id: String, quantity: Int) = offlineScreenDataSource.setQuantity(id,quantity)
